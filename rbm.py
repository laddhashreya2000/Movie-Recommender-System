...
ratings = pd.read_csv('ml-1m/ratings.dat', sep = '::', header = None, engine = 'python', encoding = 'latin-1')#last column is the time stamp...not useful

# Preparing the training set and the test set
#u1 is the first split.....we hsve five sets
